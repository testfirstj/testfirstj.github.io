...
[source,java]
----
include::{topics}/code/myfirstmock/src/main/java/myfirstmock/Printer.java[lines=8..19]
----
...
[source,java]
----
include::{topics}/code/myfirstmock/src/test/java/myfirstmock/BusinessTest.java[lines=27..37]
----
...
[source,java]
----
include::{topics}/code/myfirstmock/src/test/java/myfirstmock/BusinessTest.java[lines=39..57]
----
...
Important is that it can also be applied to [blue]*static* methods such as the well known `public static void main(String[])`
that can't be used with Dependency Inversion as we do here.
****
...
include::{exercises}/myfirstmocks.adoc[]
